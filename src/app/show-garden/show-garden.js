  ...
  var makeShareEmail = function(emails, message){
    ...
    var params = {
        "message": {
            ...
            "html": "<h4>" + userName + " shared the foodscape " + $scope.scapeName + ".</h4><p>" + message + "</p><br> Check it out here: <a href='https://scape-dev.herokuapp.com/UI/index.html#/foodscapes/"+ scape_id + "'>" + $scope.scapeName + "</a></br>",
            "autotext": true,
            "track_opens": true,
            "track_clicks": true
        }
