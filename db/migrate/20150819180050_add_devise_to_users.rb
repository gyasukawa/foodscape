class AddDeviseToUsers < ActiveRecord::Migration
  def self.up
    change_table(:users) do |t|
      ...
      # t.string :email,              null: false, default: "" already created in original user table migration/creation
  ...
  def self.down
    ...
    ## Lockable
    remove_column :users, :failed_attempts, :integer # Only if lock strategy is :failed_attempts
